...
app.use("/api/tax_master", require("./routes/taxMasterRoutes"));

app.use("/api/gst_settings", require("./routes/gstSettingsRoutes"));
app.use("/api/invoices", require("./routes/invoiceRoutes"));

app.use("/api/invoice_tax_reports", require("./routes/invoiceTaxReportRoutes"));
