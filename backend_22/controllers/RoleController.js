...
exports.getRolesDataById = async (req, res, next) => {
  try {
    const { id } = req.params;
    ...
    logger.error("Role fetch by ID failed", err);
    next(err);
  }
};
...
exports.updateRoleStatus = async (req, res, next) => {
  try {
    ...
    const result = await roleModel.updateStatus(id);
    ...
    logger.error("Role status update failed", err);
    next(err);
  }
};
...
exports.updateRole = async (req, res, next) => {
  try {
    ...
    const result = await withTransaction(async (client) => {
      return await roleModel.updateRole([name, id], client);
    });
...
exports.softDeleteRole = async (req, res, next) => {
  try {
    ...
    const result = await withTransaction(async (client) => {
      return await roleModel.softDeleteRole(id, client);
    });
...
exports.restoreRole = async (req, res, next) => {
  try {
    ...
    const result = await withTransaction(async (client) => {
      return await roleModel.restoreRole(id, client);
    });
...
exports.deleteRole = async (req, res, next) => {
  try {
    ...
    const result = await withTransaction(async (client) => {
      return await roleModel.deleteRole(id, client);
    });
