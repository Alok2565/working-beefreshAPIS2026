...
exports.getUserById = async (req, res, next) => {
  try {
    ...
    const result = await userModel.getUserByIdAll(id);
...
exports.updateUserStatus = async (req, res, next) => {
  try {
    ...
    const result = await withTransaction(async (client) => {
      // ================= UPDATE USERS =================
      const userResult = await userModel.updateStatusUser(client, id);
      ...
      // ================= UPDATE USER LOGINS =================
      const loginResult = await userLoginModel.updateStatusUserLogin(
        client,
        userId,
      );
    ...
    logger.error("User status update failed", err);
    next(err);
  }
};
...
exports.assignRoleToUser = async (req, res) => {
  try {
    ...
    await UserRoleService.assignRole(user_id, role_id);
