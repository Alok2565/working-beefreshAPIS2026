...
\restrict eWK9HBKD8kpXrbpCPdmew7asMGcFL8aM4UO4vgl6o1nfQAdOO9nubVcya8NBEro
...
CREATE TABLE public.brands (
    ...
    brand_slug character varying(20) NOT NULL,
    status boolean DEFAULT true,
    is_deleted boolean DEFAULT false,
    deleted_at timestamp without time zone,
    created_by integer,
...
--
-- Name: gst_settings; Type: TABLE; Schema: public; Owner: postgres
--
...
CREATE TABLE public.gst_settings (
    ...
    gst_number character varying(100) NOT NULL,
    ...
    default_gst_percent numeric(5,2) DEFAULT 18.00,
    ...
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT gst_settings_registration_type_check CHECK (((registration_type)::text = ANY ((ARRAY['Regular'::character varying, 'Composition'::character varying, 'Unregistered'::character varying, 'E-commerce'::character varying, 'ISD'::character varying])::text[])))
);


ALTER TABLE public.gst_settings OWNER TO postgres;

--
-- Name: gst_settings_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER SEQUENCE public.gst_settings_id_seq OWNER TO postgres;

--
-- Name: gst_settings_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: invoice_tax_reports; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.invoice_tax_reports (
    id integer NOT NULL,
    uuid uuid DEFAULT public.uuid_generate_v4(),
    invoice_id integer,
    user_id integer,
...
ALTER TABLE public.invoice_tax_reports OWNER TO postgres;

--
-- Name: invoice_tax_reports_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.invoice_tax_reports_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.invoice_tax_reports_id_seq OWNER TO postgres;

--
-- Name: invoice_tax_reports_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.invoice_tax_reports_id_seq OWNED BY public.invoice_tax_reports.id;
...
CREATE TABLE public.invoices (
    ...
    financial_year character varying(20),
    invoice_prefix character varying(50),
    subtotal numeric(10,2) DEFAULT 0,
    tax_amount numeric(10,2) DEFAULT 0,
    discount_amount numeric(10,2) DEFAULT 0,
...
CREATE TABLE public.product_variants (
    ...
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT product_variants_discount_price_check CHECK ((discount_price >= (0)::numeric)),
...
CREATE TABLE public.taxes (
    ...
    tax_slug character varying(255) NOT NULL,
    tax_code character varying(100) NOT NULL,
    tax_percent numeric(5,2) NOT NULL,
    tax_type character varying(50) DEFAULT 'GST'::character varying,
    status boolean DEFAULT true,
    is_deleted boolean DEFAULT false,
    deleted_at timestamp with time zone,
    created_by integer,
...
--
-- Name: gst_settings id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: invoice_tax_reports id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.invoice_tax_reports ALTER COLUMN id SET DEFAULT nextval('public.invoice_tax_reports_id_seq'::regclass);
...
5	44994b1a-2b8c-475a-ae13-27b7b5e656a3	1	Flavor	flavor	Mustard	sfgbdfhbdf	4	t	f	\N	\N	\N	\N	2026-05-15 16:34:07.537208+05:30	2026-05-18 11:02:50.081688+05:30
6	c8f6f63a-16c4-4fe5-93a8-0f04308824bb	4	Purity	purity	Raw Honey	Purity	5	t	f	\N	\N	\N	\N	2026-05-15 16:34:44.830744+05:30	2026-05-18 11:14:16.706177+05:30
4	438854e8-a172-4471-968a-7a7840b0d02b	2	Weight	weight	100 G	ADAsfcd 100g	1	t	f	\N	\N	\N	\N	2026-05-15 15:48:55.952414+05:30	2026-05-18 11:15:42.45661+05:30
\.
...
COPY public.brands (id, uuid, brand_name, brand_slug, status, is_deleted, deleted_at, created_by, updated_by, deleted_by, created_at, updated_at) FROM stdin;
1	1be932e0-b1db-4a1e-87c9-9effebfea92c	Bee Fresh	bee-fresh	t	f	\N	\N	\N	\N	2026-05-19 14:09:04.351191	2026-05-19 14:21:31.193862
\.
...
3	\N	Sun flower	sun-flower	This category belongs Sun flower.	t	f	\N	\N	\N	\N	2026-05-21 14:44:10.637264	2026-05-21 14:44:10.637264
\.
...
3	3	1779354850269_4359.jpg	t	t	f	\N	2026-05-21 14:44:10.637264	2026-05-21 14:44:10.637264
\.
...
--
-- Data for Name: gst_settings; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.gst_settings (id, uuid, company_name, gst_number, registration_type, invoice_prefix, default_gst_percent, currency, financial_year, state_code, address, phone, email, is_active, created_at, updated_at) FROM stdin;
1	2633361e-8582-4bfe-90ea-673bf656d651	Test	25612452526215	E-commerce	INV	18.00	INR	2025-03-01	DL	afcassvcnb vn fgnh	888251452	admin.alok@yopmail.com	t	2026-05-18 16:37:09.049063	2026-05-19 10:57:00.42003
\.
...
--
-- Data for Name: invoice_tax_reports; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.invoice_tax_reports (id, uuid, invoice_id, user_id, tax_type, tax_percent, tax_amount, total_amount, created_at) FROM stdin;
\.
...
COPY public.invoices (id, uuid, invoice_no, user_id, invoice_date, financial_year, invoice_prefix, subtotal, tax_amount, discount_amount, total_amount, tax_type, payment_status, payment_method, billing_address, shipping_address, notes, status, is_deleted, deleted_at, created_at, updated_at) FROM stdin;
\.
...
1	5	1	2	2026-05-20 17:15:00.666454
2	5	2	3	2026-05-20 17:15:00.666454
3	5	3	1	2026-05-20 17:15:00.666454
4	6	1	2	2026-05-20 17:39:20.97042
5	6	2	2	2026-05-20 17:39:20.97042
6	6	3	2	2026-05-20 17:39:20.97042
7	14	1	2	2026-05-21 14:32:07.281618
8	14	2	3	2026-05-21 14:32:07.281618
9	14	3	1	2026-05-21 14:32:07.281618
10	15	1	1	2026-05-21 14:46:24.971645
11	15	2	2	2026-05-21 14:46:24.971645
12	15	3	2	2026-05-21 14:46:24.971645
\.
...
COPY public.product_images (id, product_id, variant_id, image_path, is_primary, sort_order, status, is_deleted, deleted_at, created_at, updated_at) FROM stdin;
11	15	8	1779354984571_6424.jpg	f	0	t	f	\N	2026-05-21 14:46:24.971645	2026-05-21 14:46:24.971645
10	15	8	1779354984571_1923.jpg	f	0	t	f	\N	2026-05-21 14:46:24.971645	2026-05-21 14:46:24.971645
9	15	8	1779354984571_2906.jpg	f	0	t	f	\N	2026-05-21 14:46:24.971645	2026-05-21 14:46:24.971645
8	14	7	forest-Honey_1779354126927.jpg	f	0	t	f	\N	2026-05-21 14:32:07.281618	2026-05-21 14:32:07.281618
7	14	7	Eucalyputs-honey_1779354126927.jpg	f	0	t	f	\N	2026-05-21 14:32:07.281618	2026-05-21 14:32:07.281618
6	14	7	cranch-honey_1779354126911.jpg	f	0	t	f	\N	2026-05-21 14:32:07.281618	2026-05-21 14:32:07.281618
1	5	\N	Eucalyputs-honey_1779277500307.jpg	f	0	t	f	\N	2026-05-20 17:15:00.666454	2026-05-20 17:15:00.666454
5	6	6	Mustard-Honey_1779278960616.jpg	f	0	t	f	\N	2026-05-20 17:39:20.97042	2026-05-20 17:39:20.97042
4	6	6	Lychee-Honey_1779278960610.jpg	f	0	t	f	\N	2026-05-20 17:39:20.97042	2026-05-20 17:39:20.97042
3	6	6	jamun-Honey_1779278960593.jpg	f	0	t	f	\N	2026-05-20 17:39:20.97042	2026-05-20 17:39:20.97042
2	6	6	forest-Honey_1779278960502.jpg	f	0	t	f	\N	2026-05-20 17:39:20.97042	2026-05-20 17:39:20.97042
\.
...
COPY public.product_meta (id, product_id, meta_title, meta_keywords, meta_description, canonical_url, schema_json, og_image, created_at, updated_at) FROM stdin;
1	2	\N	\N	\N	\N	{}	\N	2026-05-20 16:35:16.123274	2026-05-20 16:35:16.123274
2	5	\N	\N	\N	\N	{}	\N	2026-05-20 17:15:00.666454	2026-05-20 17:15:00.666454
3	6	Tset	Honey, Lichee, 	szfsd dxfgdxgbdg	\N	{}	\N	2026-05-20 17:39:20.97042	2026-05-20 17:39:20.97042
4	13	\N	\N	\N	\N	{}	\N	2026-05-21 11:10:57.248468	2026-05-21 11:10:57.248468
5	14	Lichee Honey	Honey, Lichee, 	sdfasgfvsdfgv	\N	{}	\N	2026-05-21 14:32:07.281618	2026-05-21 14:32:07.281618
6	15	\N	\N	\N	\N	{}	\N	2026-05-21 14:46:24.971645	2026-05-21 14:46:24.971645
\.
...
COPY public.product_variants (id, uuid, product_id, tax_id, weight_unit_id, variant_name, sku, barcode, weight, price, discount_price, low_stock_alert, status, is_deleted, deleted_at, created_by, updated_by, deleted_by, created_at, updated_at) FROM stdin;
1	ce43c7e9-2d26-417d-b489-283cfa27bae2	5	13	8	sfsaf	Aa-2253	\N	250.00	250.00	\N	2	t	f	\N	\N	\N	\N	2026-05-20 17:15:00.666454	2026-05-20 17:15:00.666454
2	c93f44f3-efb8-4b4c-9300-acb59fe88d62	6	13	2	Tets Product	A-253222	\N	0.00	520.00	\N	5	t	f	\N	\N	\N	\N	2026-05-20 17:39:20.97042	2026-05-20 17:39:20.97042
7	decfe02d-797c-447e-8a7c-a2b6d0716962	14	12	8	Natural Honey	Nat-A52225	\N	0.00	920.00	\N	5	t	f	\N	10	\N	\N	2026-05-21 14:32:07.281618	2026-05-21 14:32:07.281618
8	8e06b199-6330-4867-904a-61b86792cef7	15	13	4	My Test Product	Sun_25652	\N	0.00	953.00	\N	5	t	f	\N	10	\N	\N	2026-05-21 14:46:24.971645	2026-05-21 14:46:24.971645
6	73e17832-bc53-4aa7-ade2-5b5d0d69b913	13	12	3	\N	adfcs-	\N	\N	\N	\N	5	t	f	\N	10	\N	\N	2026-05-21 11:10:57.248468	2026-05-21 11:10:57.248468
\.
...
COPY public.products (id, uuid, category_id, product_name, slug, sku, brand_id, short_description, long_description, thumbnail_image, is_featured, is_best_seller, is_new_arrival, seo_title, seo_keywords, seo_description, sort_order, status, is_deleted, deleted_at, created_by, updated_by, deleted_by, created_at, updated_at) FROM stdin;
14	ba620ddf-40d9-4db4-8d6d-e6559509757a	1	Natural Honey	natural-honey	Nat-A52225	\N	Short Description	Long Description	Lychee-Honey_1779354126911.jpg	f	f	f	Lichee Honey	Honey, Lichee, 	sdfasgfvsdfgv	0	t	f	\N	10	\N	\N	2026-05-21 14:32:07.281618	2026-05-21 14:32:07.281618
15	6818d847-d223-4ab4-bf2f-0fcbcac86022	3	My Test Product	my-test-product	Sun_6027	\N	My Test Product Short Description	My Test Product My Test Product	1779354984571_1147.jpg	f	f	f				0	t	f	\N	10	\N	\N	2026-05-21 14:46:24.971645	2026-05-21 14:46:24.971645
5	1b099e22-9e4d-4e53-af49-8d11609416f1	2	afdas	afdas	A-6027	1	<p>safsdgvbxcb dfxhbgfdnb dfnbg df</p>	<p>df cawawdesADASGDB DGFBDF</p>	sunflower-honey_1779277500306.jpg	f	f	f				0	t	f	\N	\N	\N	\N	2026-05-20 17:15:00.666454	2026-05-20 17:15:00.666454
6	f835c95a-d924-40c3-867b-9c1578b7ace5	1	tesatest	tesatest	A-602756	1	<p>Short Description</p>	<p>Long Description</p>	Sahjan-Honey_1779278960502.jpg	f	f	f	Tset	Honey, Lichee, 	szfsd dxfgdxgbdg	0	t	f	\N	\N	\N	\N	2026-05-20 17:39:20.97042	2026-05-20 17:39:20.97042
13	6d1a4447-18ad-406e-b2a5-b011380b0cc7	2	twewae	twewae	adfcs	1	sort Desc	Long DESc	Lychee-Honey_17793541269156.jpg	f	f	f				0	t	f	\N	10	\N	\N	2026-05-21 11:10:57.248468	2026-05-21 11:10:57.248468
2	e2b7b653-7167-4f4f-a00e-71197143cf84	2	Test	test	DV--2	1	\N	\N	sunflower-honey_1779277500333.jpg	f	f	f	\N	\N	\N	0	f	f	\N	\N	\N	\N	2026-05-20 16:35:16.123274	2026-05-20 16:35:16.123274
\.
...
COPY public.taxes (id, uuid, tax_name, tax_slug, tax_code, tax_percent, tax_type, status, is_deleted, deleted_at, created_by, updated_by, deleted_by, created_at, updated_at) FROM stdin;
3	3309ce5e-c58b-42de-8b12-bd38a152ab6f	GST 18%	gst-18	GST18	18.00	GST	t	f	\N	\N	\N	\N	2026-05-18 14:09:54.217472	2026-05-18 14:09:54.217472
4	9afc7649-ee02-4821-9ca5-faad19f4cfce	GST 12%	gst-12	GST12	12.00	GST	t	f	\N	\N	\N	\N	2026-05-18 14:10:35.793467	2026-05-18 14:10:35.793467
5	c7777aad-74a9-40a9-9a41-f83505c7b4af	GST 28%	gst-28	GST28	28.00	GST	t	f	\N	\N	\N	\N	2026-05-18 14:11:13.984807	2026-05-18 14:11:13.984807
10	8b905489-a321-4709-9f5a-c114f6bc0f56	CGST 6%	cgst-6	CGST06	6.00	CGST	t	f	\N	\N	\N	\N	2026-05-18 14:50:58.372019	2026-05-18 14:50:58.372019
6	4ddd47b4-d226-47a1-962d-3e717ac40df6	CGST 9%	cgst-9	CGST09	9.00	CGST	t	f	\N	\N	\N	\N	2026-05-18 14:48:46.490861	2026-05-18 14:48:46.490861
7	a29b32fe-5ae2-4b92-9bf9-607debc56d5b	SGST 9%	sgst-9	SGST09	9.00	SGST	t	f	\N	\N	\N	\N	2026-05-18 14:49:57.981433	2026-05-18 14:49:57.981433
11	2ceaf22f-1ec2-4d09-9318-c2e67fbff07f	SGST 6%	sgst-6	SGST06	6.00	SGST	t	f	\N	\N	\N	\N	2026-05-18 14:52:17.747499	2026-05-18 14:52:17.747499
12	2f06b26a-fbf7-4617-8aae-6c83ae4f0d1a	IGST 18%	igst-18	IGST18	18.00	IGST	t	f	\N	\N	\N	\N	2026-05-18 14:53:22.553764	2026-05-18 14:53:22.553764
13	ad898236-db93-44b4-ae98-03cc2c945d4e	IGST 12%	igst-12	IGST12	12.00	IGST	t	f	\N	\N	\N	\N	2026-05-18 14:53:50.844919	2026-05-18 14:53:50.844919
2	2d0a1f78-8436-44de-a7a5-3093f26d93d1	GST 5%	gst-5	GST05	5.00	GST	t	f	\N	\N	\N	\N	2026-05-18 14:05:12.360593	2026-05-18 14:05:12.360593
14	eeb78db1-cce4-4baa-9240-2b9cec38c288	IGST 05%	igst-05	IGST 05	5.00	IGST	t	f	\N	\N	\N	\N	2026-05-18 14:54:36.241438	2026-05-18 14:54:36.241438
\.
...
10	10	$2b$10$Z3Ck2.EdyB3RBDNa2LbuIO3jJIFIh8aiJ0Xyb7ppB6SsK62/y///W	2026-04-28 11:09:16.641864	\N	\N	t	f	\N	2026-05-21 09:54:34.352431	127.0.0.1	2026-04-28 10:29:36.957169	2026-04-28 10:29:36.957169
\.
...
SELECT pg_catalog.setval('public.category_images_id_seq', 3, true);
...
--
-- Name: gst_settings_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
--
-- Name: invoice_tax_reports_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.invoice_tax_reports_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.product_attribute_mapping_id_seq', 12, true);
...
SELECT pg_catalog.setval('public.product_meta_id_seq', 6, true);
...
SELECT pg_catalog.setval('public.taxes_id_seq', 14, true);
...
--
-- Name: brands brands_brand_slug_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: gst_settings gst_settings_gst_number_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.gst_settings
    ADD CONSTRAINT gst_settings_gst_number_key UNIQUE (gst_number);


--
-- Name: gst_settings gst_settings_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: invoice_tax_reports invoice_tax_reports_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.invoice_tax_reports
    ADD CONSTRAINT invoice_tax_reports_pkey PRIMARY KEY (id);
...
--
-- Name: idx_prod_attr_mapping; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_prod_attr_mapping ON public.product_attribute_mapping USING btree (product_id, attribute_id);
...
--
-- Name: brands brands_deleted_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.brands
    ADD CONSTRAINT brands_deleted_by_fkey FOREIGN KEY (deleted_by) REFERENCES public.users(id);


--
-- Name: brands brands_updated_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.brands
    ADD CONSTRAINT brands_updated_by_fkey FOREIGN KEY (updated_by) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.products
    ADD CONSTRAINT fk_products_brands FOREIGN KEY (brand_id) REFERENCES public.brands(id);
...
--
-- Name: invoice_tax_reports invoice_tax_reports_invoice_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.invoice_tax_reports
    ADD CONSTRAINT invoice_tax_reports_invoice_id_fkey FOREIGN KEY (invoice_id) REFERENCES public.invoices(id) ON DELETE CASCADE;


--
-- Name: invoice_tax_reports invoice_tax_reports_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.invoice_tax_reports
    ADD CONSTRAINT invoice_tax_reports_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.product_variants
    ADD CONSTRAINT product_variants_tax_id_fkey FOREIGN KEY (tax_id) REFERENCES public.taxes(id) ON DELETE SET NULL;
...
--
-- Name: product_variants product_variants_weight_unit_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.product_variants
    ADD CONSTRAINT product_variants_weight_unit_id_fkey FOREIGN KEY (weight_unit_id) REFERENCES public.weight_units(id) ON DELETE SET NULL;
...
\unrestrict eWK9HBKD8kpXrbpCPdmew7asMGcFL8aM4UO4vgl6o1nfQAdOO9nubVcya8NBEro
