      ...
      children: [
        {
          ...
          nested_children: [
            ...
            {
              name: "Add Product",
              path: "/admin/manage/product/add-new",
              icon: FaRegListAlt,
            },
            {
        ...
        { name: "Brands", path: "/admin/manage/brands", icon: FaBox },
      ],
    },
    {
      ...
      children: [
        {
          ...
          nested_children: [
            {
              name: "All Taxes",
              path: "/admin/manage/products/taxes",
              icon: FaRegListAlt,
            },
            {
              name: "Add Tax",
      ...
      children: [
        ...
        },
        {
          ...
          nested_children: [
            {
              name: "Invoice Lists",
              path: "/admin/manage/orders/invoices",
              icon: FaRegListAlt,
            },
            {
              name: "Add New",
