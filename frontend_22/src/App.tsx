...
import MyOrder from "./pages/customer/orders/MyOrder";
    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/" element={<Layouts />}>
          ...
          />
          <Route
            path="shops/orders/payment/payment-success"
            element={
              <ProtectedRoute>
                <PaymentSuccess />
              </ProtectedRoute>
