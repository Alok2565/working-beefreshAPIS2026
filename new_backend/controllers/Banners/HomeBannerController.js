...
//     logger.error("Banner creation failed", err);
//     next(err);
//   }
// };
exports.createHomeBanner = async (req, res, next) => {
  try {
    ...
    // ✅ FIX: prevent array injection bug
    ...
    // ✅ store ONLY filename
    const ipAddress = req.clientIP; // ✅ FROM MIDDLEWARE
    ...
    // ✅ build full image URL for response only
