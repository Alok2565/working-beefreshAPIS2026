...
const UserRoleModel = require("../models/UserModel");

const UserRoleService = {
  assignRole: async (user_ids, role_id) => {
    if (!user_ids.length || !role_id) {
      throw new Error("Invalid data");
    }

    return await UserRoleModel.assignRoleToUsers(user_ids, role_id);
  },
};
